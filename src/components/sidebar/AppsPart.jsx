    ...
    <li className="sidebar-item" ref={isExpanded || isNavExpanded.isSmall || layoutPosition.horizontal || (layoutPosition.twoColumn && isExpanded) || (layoutPosition.twoColumn && isSmallScreen) ? mainAppsDropdownRef : null}>
      ...
      `}>       
        ...
        <li className="sidebar-dropdown-item">
          ...
          <li className="sidebar-dropdown-item">
            <NavLink to="/customeramount" className="sidebar-link" onClick={handleSubNavLinkClick}>
              All Customer Amount
            </NavLink>
          </li>
          <li className="sidebar-dropdown-item">
          ...
          <li className="sidebar-dropdown-item">
            <NavLink to="/leaveapply" className="sidebar-link" onClick={handleSubNavLinkClick}>
        ...
        <li className="sidebar-dropdown-item">
          ...
          >
            ...
            <li className="sidebar-dropdown-item">
              <NavLink to="/routeProduct" className="sidebar-link" onClick={handleSubNavLinkClick}>
                Route Based<br/>
                Product Lists
              </NavLink>
            </li>
            ...
            <li className="sidebar-dropdown-item">
              <NavLink to="/banner" className="sidebar-link" onClick={handleSubNavLinkClick}>
                Banner
              </NavLink>
            </li>
